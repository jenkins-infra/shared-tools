locals {
  ...
  controller_principal_id     = var.controller_service_principal_end_date == "" ? azurerm_linux_virtual_machine.controller.identity[0].principal_id : azuread_service_principal.controller[0].object_id
}
