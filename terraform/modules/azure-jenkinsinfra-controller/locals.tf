locals {
  ...
  controller_principal_id     = var.enable_vm_system_identity ? azurerm_linux_virtual_machine.controller.identity[0].principal_id : azuread_service_principal.controller[0].object_id
}
